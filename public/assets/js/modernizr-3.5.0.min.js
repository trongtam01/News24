...
!(function (e, t, n) {
  ...
  function d(e, n, r, a) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (l = s("div")), (l.id = a ? a[r] : d + (r + 1)), f.appendChild(l);
    return (
      (o = s("style")),
      (o.type = "text/css"),
      (o.id = "s" + d),
  ...
  function v(e, t, a, o) {
    ...
    for (
      var d, f, p, m, g, v = ["modernizr", "tspan", "samp"];
      !D.style && v.length;

    )
      (d = !0), (D.modElem = s(v.shift())), (D.style = D.modElem.style);
        ...
        o &&
          ...
          /^range$/.test(r) && N.style.WebkitAppearance !== n
            ? (S.appendChild(N),
              ...
              (o =
                a.getComputedStyle &&
                "textfield" !== a.getComputedStyle(N, null).WebkitAppearance &&
                0 !== N.offsetHeight),
              S.removeChild(N))
            : /^(search|tel)$/.test(r) ||
              (o = /^(url|email)$/.test(r)
                ? N.checkValidity && N.checkValidity() === !1
                : N.value != s)),
        (j[e[l]] = !!o);
    return j;
  })(A)),
  ...
  Modernizr.addTest("svgclippaths", function () {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(
        F.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath"))
      )
    );
  });
  var M = (function () {
